 ...
 * @since 2021/11/2
 */
public class SystemRuntimeGrabber implements Grabber<String> {

    private static final long MB = 1024 * 1024;

    @Override
    public String getInfo() {
//        StringBuilder builder = new StringBuilder("Memory Pool:\n");
//        List<MemoryPoolMXBean> pools = ManagementFactory.getMemoryPoolMXBeans();
//        for (MemoryPoolMXBean p : pools) {
//            builder.append("[").append(p.getName()).append(":\n");
//            MemoryUsage u = p.getUsage();
//            builder.append(" Init=").append(u.getInit() / 1024 / 1024).append("M\n");
//            builder.append(" Used=").append(u.getUsed() / 1024 / 1024).append("M\n");
//            builder.append(" Max=").append(u.getMax() / 1024 / 1024).append("M\n");
//            builder.append(" Committed=").append(u.getCommitted() / 1024 / 1024).append("M\n");
//
//            Double percentage = (u.getMax() / 1024 / 1024) == 0 ? 0 : Long.valueOf(u.getUsed()).doubleValue() / u.getMax();
//            builder.append(" Percentage=").append(percentage).append("%\n");
//            builder.append("]\n");
//        }
//
//        MemoryUsage hmu = ManagementFactory.getMemoryMXBean().getHeapMemoryUsage();
//        builder.append("[").append("Heap Memory").append(":\n");
//        builder.append(" Committed=").append(hmu.getCommitted() / 1024 / 1024).append("\n");
//        builder.append(" Init=").append(hmu.getInit() / 1024 / 1024).append("\n");
//        builder.append(" Used=").append(hmu.getUsed() / 1024 / 1024).append("\n");
//        builder.append(" Max=").append(hmu.getMax() / 1024 / 1024).append("\n");
//        Double percentage = (hmu.getMax() / 1024 / 1024) == 0 ? 0 : Long.valueOf(hmu.getUsed()).doubleValue() / hmu.getMax();
//        builder.append(" Percentage=").append(percentage).append("%\n").append("\n]");
        //打印系统信息
